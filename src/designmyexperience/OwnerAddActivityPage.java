...
public class OwnerAddActivityPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(dcDate, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                .addComponent(txtAddress)))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(cbMaxParticipant, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jLabel9.setText("My Design Experience ");
    ...
    private void btnBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseActionPerformed
        ...
        // Correct filter to allow only JPG, JPEG, and PNG
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Images (JPG, JPEG, PNG)", "jpg", "jpeg", "png");
        file.setFileFilter(filter);

        int output = file.showOpenDialog(this); // Use showOpenDialog instead of showSaveDialog

        if (output == JFileChooser.APPROVE_OPTION) {
            File selectedFile = file.getSelectedFile();
            String path = selectedFile.getAbsolutePath();

            // Validate the file extension manually in case the user tries to bypass the filter
            if (path.toLowerCase().endsWith(".jpg") || path.toLowerCase().endsWith(".jpeg") || path.toLowerCase().endsWith(".png")) {
                ...
                JOptionPane.showMessageDialog(this, "Invalid file type. Please select a JPG, JPEG, or PNG image.", "File Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        OwnerManageActivityPage p = new OwnerManageActivityPage(currentUser);
        p.setVisible(true);
        this.dispose();
